...
namespace Stateless
{
    ...
    public partial class StateMachine<TState, TTrigger>
    {
        ...
        private Func<TState> _stateAccessor;
        private Action<TState> _stateMutator;
        private Action<Transition> _transitionAction;
        ...
        public void Reset()
        {
            var reference = new StateReference {State = _initialState};
        ...
        private void InternalFire(TTrigger trigger, params object[] args)
        {
            ...
            {
                if (CurrentRepresentation.OnUnhandled != null)
                    CurrentRepresentation.OnUnhandled(CurrentRepresentation.UnderlyingState, trigger);
                else
            ...
            if (triggerBehaviour.ResultsInTransitionFrom(source, args, out destination))
            {
                ...
                _transitionAction?.Invoke(transition);
        ...
        public void OnTransition(Action<Transition> action)
        {
